...
<div class="container-fluid mt-4">
  <div class="row">
    ...
    <div class="col-lg-8 col-md-8 col-sm-12">
        <div class="card">
            <div class="card-header bg-info">Add User</div>
            <div class="card-body">
                        ...
                        @csrf
                            <div class="form-group">
                                <tr>
                                    ...
                                    <td>
                                        <input id="name" type="text" class="form-control @error('name') invalid @enderror" name="name" value="{{ old('name') }}"  autocomplete="name">
                                        @error('name')
                            ...
                            <div class="form-group">
                                <tr>
                                    ...
                                    <td>
                                        <input id="email" type="text" class="form-control @error('email') invalid @enderror" name="email" value="{{ old('email') }}"  autocomplete="email">
                                        @error('email')
                                            <small class="text-danger">{{$message}}</small>
                                        @enderror
                                    </td>
                            ...
                            <div class="form-group">
                                <tr>
                                    ...
                                    <td>
                                        <input id="password" type="password" class="form-control @error('password') invalid @enderror" name="password" value="{{ old('password') }}"  autocomplete="password">
                                        @error('password')
                                            <small class="text-danger">{{$message}}</small>
                                        @enderror
                                    </td>
                            ...
                            <div class="form-group">
                                <tr ><td colspan="2"><button type="submit" class="btn btn-success">Register</button></td></tr>
                            </div>
                        </form>
                        </tbody>
                    </table>
